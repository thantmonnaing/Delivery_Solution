		...
		<div class="col-xl-10 col-lg-12 col-md-9">
			...
			<div class="card o-hidden border-0 shadow-lg my-5">
				<div class="card-body p-0">
					...
					<form method="POST" action="{{route('frontend.deliverupdate',$deliver->user->id)}}" enctype="multipart/form-data">
						@csrf
						{{-- @method('PUT') --}}
						<input type="hidden" name="user_id" value="{{$deliver->user_id}}">
						<input type="hidden" name="status" value="{{$deliver->status}}">
						<div class="row">
							<div class="col-lg-4 d-none d-lg-block bg-login-image mt-5">
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item">
										<a href="#oldphoto" class="nav-link active" id="oldphoto_tab" data-toggle="tab" role="tab" aria-controls="oldphoto" aria-selected="true">Old photo</a>
									</li>
							...
							<div class="col-lg-8">
								<div class="p-5">
									<div class="form-group">
										<label for="name" class="col-form-label">Name</label>
										<input id="name" type="text" class="form-control form-control-user @error('name') is-invalid @enderror" name="name" value="{{$deliver->user->name}}" required autocomplete="name" autofocus>
										@error('name')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
									...
									<div class="form-group">
										<label for="email" class="col-form-label">Email</label>
										<input id="email" type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email" value="{{$deliver->user->email}}" required autocomplete="email">
									...
									<div class="form-group">
										<label>Phone no:</label>
										<input type="text" name="phone" class="form-control form-control-user @error('phone') is-invalid @enderror" value="{{$deliver->phone}}">
										@error('phone')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
									...
									<div class="form-group row">
										<div class="col-lg-4 form-group date">
											<label for="start_time">Job Time(Start Time)</label>
											<input id="start_time" type="time" name="time" class="form-control @error('time') is-invalid @enderror"  value="{{ $deliver->job_time }}" id="start_time" required autocomplete="start_time" autofocus  required>
											@error('time')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
										...
										<div class="col-lg-4 date">
											<label for="end_time">Job Time(End Time)</label>
											<input id="end_time" type="time" name="time" class="form-control @error('time') is-invalid @enderror"  value="{{$deliver->job_time }}" id="end_time" required autocomplete="end_time" autofocus required>
											@error('time')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
									...
									<div class="form-group">
										<label class="mr-5 ">Job Type</label>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" id="fulltime" name="job" value="fulltime" required>
											<label class="form-check-label" for="fulltime">Full Time</label>
										</div>
									...
									<div class="form-group">
										<label class="mr-5 ">Job Day</label>
										<div class="form-check form-check-inline">  					
									...
									<div class="form-group">
										<label class="mr-3">Trasport Type</label>
										<div class="form-check form-check-inline">  					
											<input class="form-check-input" type="radio" name="transport" id="inlineRadio1" value="car" required>
											<label class="form-check-label" for="inlineRadio1">Car</label>
										</div>
									...
									<div class="form-group">
										<label class="mr-3">Payment Type</label>
										<div class="form-check form-check-inline">	
